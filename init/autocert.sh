...
kubectl apply -f https://raw.githubusercontent.com/smallstep/autocert/install/01-step-ca.yaml
...
kubectl apply -f https://raw.githubusercontent.com/smallstep/autocert/install/02-autocert.yaml
kubectl apply -f https://raw.githubusercontent.com/smallstep/autocert/install/03-rbac.yaml
